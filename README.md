# OldVNKeeper Releases

Public release assets for OldVNKeeper-related fan translation patches.

This repository is intended to keep downloadable release archives separate from
the patching/tool source repositories. The git history should contain only
metadata and documentation. Release archives are attached to GitHub Releases.

These releases are unofficial fan patches. They are not official releases by
the original game developers or publishers.
...
binaries unless the license explicitly permits redistribution.
